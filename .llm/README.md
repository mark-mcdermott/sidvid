...
- `STATE-WORKFLOW-SPEC.md` - **PRIMARY** - All workflow states, transitions, UI behavior
- `SCHEMAS-SPEC.md` - **DATA STRUCTURES** - JSON schemas for all data types

**Project context:**
- `sidvid-overview.md` - SidVid project vision, features, and development status
...
- `coding-patterns.md` - Library patterns, UI patterns, API integration
- `testing-strategy.md` - Test organization and when to use each type
- `development-commands.md` - How to run tests, build, and use CLI
- `web-access.md` - Development environment and API access
